...
class VAEDataLoader:
    """
    The main class responsible for handling the Reduced MNIST dataset.
    ...
    def __init__(self):
        ...
        Initializes the fundamental absolute paths for inputs and outputs.
        
        Variables:
            self.dataset_path (str): The absolute path to the original dataset.
            self.out_base (str): The specific output directory for Prob1_VAE.
        ...
        # Specific absolute path for Prob1_VAE Outputs
    ...
    def prepare_baselines_and_load(self):
        ...
        """
        print(">>> Starting to sample and copy baselines...")
        ...
        for digit in range(10):
            ...
            for img_name in sampled_1000:
                ...
                if img_name in sampled_350:
                    ...
                    # Normalize pixels from [0, 255] to [0.0, 1.0] for VAE constraints
