...
We use a custom dataset (\texttt{emotion\_dataset\_v2.jsonl}) containing 100 Arabic sentences distributed approximately equally across three linguistic registers:
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|l|}
        ...
        \textarabic{خوف} & Fear \\
        \textarabic{اندهاش} / \textarabic{مفاجأة} & Surprise \\
...
Manual adjudication significantly improved the accuracy scores of all models. Notably, GPT-4o-mini achieved an outstanding 91.0\% adjusted accuracy in zero-shot mode. This highlights that many apparent ``errors'' by LLMs in Arabic NLP are actually acceptable alternative formulations rather than true failures.
\end{reportblock}
